...
const Weather = () => {
  ...
  const Back = () => {
    ...
    detailsRef.current[1].style.visibility = "visible";
    detailsRef.current[2].style.visibility = "visible";
    detailsRef.current[3].style.display = "none";
  };
  ...
  const getDaySummary = (items) => {
    if (!items || items.length === 0)
      return { avgTemp: 0, condition: "☀️ Clear" };
  ...
  return (
    <div className="weather">
        ...
        <>
          ...
          <div className="header" ref={(el) => (detailsRef.current[2] = el)}>
            ...
            <p onClick={() => setShowSearch(!showSearch)}>
              {showSearch ? (
                <span className="material-symbols-outlined" id="closeIcon">
                  close
                </span>
              ) : (
                <span
                  ...
                  {threeDayKeys.map((date, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={
                          selectedDate === date ? "activeDateTab" : "selectButton"
                        }
                      >
                        {btn.label}
                        <br />
	  ...
	  <h4>Contact: +234 808 160 4340</h4>
	  <h4>Do not share my personal information</h4>
	  <h4>© PMO</h4>
	  </section>
    </div>
  );
